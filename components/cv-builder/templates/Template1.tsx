            ...
            <div className="bg-white p-6 w-full md:w-2/3">
                ...
                <div className="mt-6">
                    ...
                    {education.map((edu, index) => (
                        <div key={index} className="pl-4 border-l-2 border-gray-800">
                            <h3 className="text-lg mt-[-2px] capitalize leading-none mb-2 font-semibold relative before:content-[''] before:w-[12px] before:h-[12px] before:bg-gray-800 before:rounded-full before:absolute before:-left-[22px] before:top-[0]">{edu.degree}</h3>
